\fix{Maybe change 0 and 1 for $\cM$ and $\cH$?}
...
Finally, for sets of weakly-hard constraints $\Lambda$ we construct the automaton $\GG{\Lambda^*}$ for the dominant set $\Lambda^* \subseteq \Lambda$. 
