\resizebox{\textwidth}{!}{
    \begin{minipage}[c]{0.6\columnwidth}
        \begin{center}
            ...
            {\Large $\GG{\lambda_1},\, \lambda_1 = \binom{1}{3}$}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{1.25\columnwidth}
        \begin{center}
            \begin{tikzpicture}[>=latex,
                                ]
            ...
            {\Large $\GG{\lambda_2},\, \lambda_2 = \genfrac{<}{>}{0pt}{}{2}{6}$}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{\columnwidth}
        \begin{center}
            ...
            {$\qquad$\Large $\GG{\Lambda},\, \Lambda = \left\{ \lambda_1,\, \lambda_2 \right\}$}
        \end{center}
    \end{minipage}
}
