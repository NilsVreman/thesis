...
\fix{change to positive feedback convention in order to make the papers more coherent?}
\begin{equation*}
...
\fix{Maybe include the example from the "longpaper". Currently included as a comment}
