...
\begin{groupplot}[group style = {group size = 4 by 9, vertical sep=8mm, horizontal sep=8mm},
    ...
    \nextgroupplot[title={\textcolor{white}{p}\tKH{}\textcolor{white}{p}}, ymax=70, ylabel={\textbf{$\,\,$Batch 1}},
