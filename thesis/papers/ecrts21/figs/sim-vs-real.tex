...
\begin{groupplot}[clip mode=individual,
    ...
    \node[clip=false, anchor=south] at (axis cs:1,62) {\phantom{p}\textbf{Kill\&Hold}\phantom{p}};
    ...
    \node[clip=false, anchor=south] at (axis cs:1,62) {\textbf{Skip\&Hold}};
    ...
    \node[clip=false, anchor=south] at (axis cs:1,10) {\phantom{p}\textbf{Kill\&Zero}\phantom{p}};
