...
%
\begin{definition}[Computational Outcome Set - Kill]%
    \label{def:kill}%
...
\end{definition}
%
\begin{definition}[Computational Outcome Set - Skip]%
    \label{def:skip}%
...
For both kill and skip, each control period contains \emph{at most} one activated and one completed job.
