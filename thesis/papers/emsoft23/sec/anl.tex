...
\begin{definition}[Markov Chain]
    ...
    \nv{should $\Theta$ be $\VV{}$ from kappa?}
    \begin{enumerate}[label=(\roman*)]
...
\footnote{%
Eigenvalue decomposition has a computational complexity of $O(n^{2.376})$ using the Coppersmith and Winograd algorithm.
...
Based on empirical tests, for $n=8$ dimensional systems the analysis takes at most $1$ second.
}
