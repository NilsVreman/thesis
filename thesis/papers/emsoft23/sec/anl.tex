...
Therefore, the probability to reach any state in the Markov chain is the same, regardless of the current state. \mm{Even though I know and understand what you mean, I think this could be confusing for some readers because they may think that the probability is then the same for every state.}
