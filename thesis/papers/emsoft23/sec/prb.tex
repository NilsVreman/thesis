...
Combining the dynamical models of the plant and controller, i.e., Equations~\eqref{eq:plant} and~\eqref{eq:ctrler}, we obtain the \emph{closed-loop system} $\clsys$.
%
\begin{equation}
    \label{eq:clsys}
