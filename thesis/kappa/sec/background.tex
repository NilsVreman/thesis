...
For instance, consider a continuous-time and discrete-time LTI plant model~\eqref{eq:discrete-lti-plant}; the Hurwitz respectively Schur stability criterion is then:
%
\begin{table}[h]
