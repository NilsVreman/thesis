...
%
\question%
{Should I mention something about soft real-time models as well here (since we use it in Paper 2 and 5)?}%
{}
...
\begin{itemize}
    ...
    \item \tS{} -- (also sometimes referred to as \emph{Skip-Next} or \emph{Continue})
\end{itemize}
%
A method for utilising both kill and skip for packet dropping in a real-time networked control system is presented in~\addref{}.
