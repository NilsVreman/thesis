...
\begin{itemize}
    ...
    \item Maybe create a simple practical example (e.g., breaks in a car) that
...
\subsubsection*{Modelling Execution using Automata}%
%
\begin{itemize}
    \item This section should maybe be moved?
    \item Entire subsubsection requested by KE
    \item More automata theory
    \item Difference from timed automata
    \item Include markov theory here?
\end{itemize}
