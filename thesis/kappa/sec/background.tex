...
With these assumptions, together with the initial condition on the closed-loop state's mean value and covariance being respectively $\E{\tilde{x}_0} = m_0$ and $\cov{\tilde{x}_0} = R_0$, it is now possible to describe how to evaluate Equation~\eqref{eq:cost}.
