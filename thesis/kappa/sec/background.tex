...
\nv{Mention what is common in microcontrollers}
...
When the processor needs to access some data, it first examines whether it exists in the cache and otherwise it collects it from the main memory.
