...
\nv{Mention why we add it here? It is simple to remove the problem of discretising the continuous process disturbance. It could be added to the continuous plant as well and then discretise it (and be sad because of all the extra work we have to do).}
