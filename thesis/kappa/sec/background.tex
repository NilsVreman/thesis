...
\end{definition}
%
\nv{Write why deadline overruns can occur}
...
\nv{Write something more here about orchestration, schedules, deadline overruns, and lead it automatically into the paragraph about scheduling}


%\note{Continue here (maybe take some inspiration from Björn)}
