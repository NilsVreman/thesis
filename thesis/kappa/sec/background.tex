...
This allows the entire system to be modeled as a MJLS where the stationary performance can be computed by solving a set of linear equations. The \code{JitterTime} toolbox for Matlab and Julia~(\url{https://github.com/X-N-C/JitterTime.jl}) was developed to provide similar functionality, with more freedom for the user to design the different components' timing models.
