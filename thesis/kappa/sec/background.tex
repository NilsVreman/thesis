...
\nv{Mention something about DMA and how the peripheral typically writes directly into main memory}
...
Generally, this will degrade the control performance~\addref{}.
However, if enough packets are lost it could cause critical system failures or crashes~\addref{}.
\question%
