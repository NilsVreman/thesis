...
%\mm{I don't like the passive form in this sentence, in particular because the thesis is then about software-induced errors (in a way). I would expect you to ``own'' the topic here.}
...
%These concepts are then thoroughly defined in Chapter~\ref{ch:background}.
...
\label{sec:intro:rts}%
%
\fix{This entire paragraph needs reworking!}
%
...
Holding off the deadline would result in fewer control updates, severely degrading the control system's performance.
