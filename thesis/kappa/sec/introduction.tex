...
\begin{enumerate}
    ...
    \item Give a positive and bold statement of what this thesis is doing.
        \begin{itemize}
            \item We present novel theoretical and practically applicable analytical tools to help analyse these systems and make sure that
        ...
        \end{itemize}
    \item The consequences of the thesis (preferrably ``solve'' the problem in~\ref{item:pitch1})
        \begin{itemize}
