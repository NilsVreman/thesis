...
\node[task,opacity=0.4] (t1) at (-2+0*\delta,1.6-0*\delta) {\textcolor{white}{Task $\#3$} \\\textcolor{white}{\faFileCode[regular]}};
\node[task,opacity=0.7] (t2) at (-2+1*\delta,1.6-1*\delta) {\textcolor{white}{Task $\#2$} \\\textcolor{white}{\faFileCode[regular]}};
\node[task,opacity=1.0] (t3) at (-2+2*\delta,1.6-2*\delta) {Task $\#1$ \\\faFileCode[regular]};

\node[task,opacity=0.4] (ct1) at (1+0*\delta,1.6-0*\delta) {\textcolor{white}{Control-Task $\#3$} \\\textcolor{white}{\faFileCode[regular]}};
\node[task,opacity=0.7] (ct2) at (1+1*\delta,1.6-1*\delta) {\textcolor{white}{Control-Task $\#2$} \\\textcolor{white}{\faFileCode[regular]}};
