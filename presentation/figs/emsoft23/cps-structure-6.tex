...
\node[task,opacity=1.0] (ct3) at (1.5+2*\delta,1.6-2*\delta) {\textcolor{red}{Control Task $\#1$} \\\textcolor{red}{\faFileCode[regular]}};
...
%%% Packets
\node (packetS) at ([xshift=-0.25cm, yshift=-0.4cm]phys.west) {\textcolor{hicolour!85!white}{\faBox}};
