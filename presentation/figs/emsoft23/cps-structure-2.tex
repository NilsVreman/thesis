...
%%% Packets
\node[xscale=-1] (packetS) at ([xshift=-0.25cm, yshift=-0.40cm]phys.west) {\textcolor{blue}{\faComment[regular]}};

\node (packetA) at ([xshift=0.5cm, yshift=0.90cm]hwi.south) {\textcolor{blue}{\faComment[regular]}};
