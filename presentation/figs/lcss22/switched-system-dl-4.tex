...
\node[eng-step, draw=lqgcolour] (c2) at (-2.25, 0.15) {\textcolor{lqgcolour}{\Large$\mathcal{C}$}};
\node[eng-step, draw=red!80!black] (c1) at (-2.10, 0) {\textcolor{red!80!black}{\Large$\mathcal{C}$}};
\coordinate (c) at (-4, 0);
