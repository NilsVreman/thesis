\begin{tikzpicture}
    ...
    \node[draw, rectangle, align=center, ultra thick, fill=hicolour!30] at (7, 2.5) {Can we say something\\about the relation between two\\ \emph{generic} \tAH{} and \tRH{}\\constraints?};
