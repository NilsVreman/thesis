...
% Requirement
%\phantom{\node[align=center, blue] (req) at (3,3.5) {Requirements dependant\\on the system};}
%\phantom{\draw[-latex, thick, blue] (req) to (ct3);}

%%% CODESIGN %%%

\begin{scope}
    \clip (-5,-1) rectangle (5, 4);
    \phantom{\node[ellipse, draw, thick, blue, fit=(ct3)] (el-ct3) {};}
    \phantom{\node[ellipse, draw, thick, blue, fit=(rtos)] (el-rtos) {};}
    \phantom{\draw[latex-latex, blue, in=180,out=90, thick] (el-ct3.north) to node[left, xshift=-1cm, yshift=-5mm] {Co-Design!} (el-rtos.west);}
\end{scope}
