...
% Requirement
%\node[align=center, hicolour] (req) at (3,3.5) {Requirements dependant\\on the system};
%\draw[-latex, thick, hicolour] (req) to (ct3);

%%% CODESIGN %%%

\begin{scope}
    \clip (-5,-1) rectangle (5, 4);
    \node[ellipse, draw, thick, hicolour, fit=(ct3)] (el-ct3) {};
    \node[ellipse, draw, thick, hicolour, fit=(rtos)] (el-rtos) {};
    \draw[latex-latex, hicolour, in=180,out=90, thick] (el-ct3.north) to node[left, xshift=-1cm, yshift=-5mm] {Co-Design!} (el-rtos.west);
\end{scope}
