...
%%% Middle plot
% Execution traces
\draw[black, fill=baselinecolor!40!red] (e1start) -- ($(e1start)+(0,0.25)$) -- (2.67,1.25) node[above] {\textcolor{baselinecolor!40!red}{Skip}} -- (2.67,1);
...
\node[above, xshift=0.4cm, baselinecolor!40!red] at ($(u2)+(0,-0.2)$) {Zero};
